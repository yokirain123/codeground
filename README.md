...
1. Open `/courses` and create a course.
2. Use a supported language name and the `Beginner` level to synchronize its
   built-in chapters automatically.
3. Open `/admin/exercises` to generate missing exercise content by chapter or
