import type { Metadata, ResolvedMetadata, ResolvedViewport, Viewport } from 'next/dist/lib/metadata/types/metadata-interface';
...
export declare function resolveMetadata(tree: LoaderTree, pathname: Promise<string>, searchParams: Promise<ParsedUrlQuery>, errorConvention: MetadataErrorType | undefined, interpolatedParams: Params, metadataContext: MetadataContext, isRuntimePrefetchable: boolean): Promise<ResolvedMetadata>;
export declare function resolveViewport(tree: LoaderTree, searchParams: Promise<ParsedUrlQuery>, errorConvention: MetadataErrorType | undefined, interpolatedParams: Params, isRuntimePrefetchable: boolean): Promise<ResolvedViewport>;
export {};
