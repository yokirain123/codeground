...
export declare const NEXT_NAV_DEPLOYMENT_ID_HEADER = "x-nextjs-deployment-id";
...
export declare const NEXT_RESUME_STATE_LENGTH_HEADER = "x-next-resume-state-length";
...
export declare const NEXT_CACHE_ROOT_PARAM_TAG_ID = "_N_RP_";
export declare const CACHE_ONE_YEAR_SECONDS = 31536000;
