import { PHASE_DEVELOPMENT_SERVER, type PHASE_PRODUCTION_SERVER, type PHASE_TYPE } from 'next/dist/shared/lib/constants';
import type { ExperimentalConfig, NextConfigComplete, NextConfig, NextConfigRuntime } from 'next/dist/server/config-shared';
