...
import { type HmrMessageSentToBrowser, type NextJsHotReloaderInterface } from 'next/dist/server/dev/hot-reloader-types';
/**
...
export declare class DevBundlerService {
    ...
    revalidate({ urlPath, headers, opts: revalidateOpts, }: {
        urlPath: string;
