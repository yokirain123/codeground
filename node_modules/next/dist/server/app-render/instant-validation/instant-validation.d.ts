import type { InitialRSCPayload, Segment } from 'next/dist/shared/lib/app-router-types';
import { RenderStage } from 'next/dist/server/app-render/staged-rendering';
...
import type { Instant } from 'next/dist/build/segment-config/app/app-segment-config';
