import type { InstantSample } from 'next/dist/build/segment-config/app/app-segment-config';
...
import { InstantValidationError } from 'next/dist/server/app-render/instant-validation/instant-validation-error';
...
export declare function createRelativeURLFromSamples(route: string, sampleParams: InstantSample['params'], sampleSearchParams: InstantSample['searchParams']): import("next/dist/shared/lib/router/utils/parse-relative-url").ParsedRelativeUrl;
