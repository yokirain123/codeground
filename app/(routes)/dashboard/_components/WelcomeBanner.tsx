...
export default function WelcomeBanner() {
  ...
  const displayName =
    user?.firstName || user?.fullName || user?.username || t("Adventurer");

  return (
    <section className="relative overflow-hidden border-2 border-[#899DFF]/45 bg-[#10152A] px-4 py-5 shadow-[7px_7px_0_#020307] sm:px-7">
      <div
        aria-hidden="true"
      ...
      <div className="relative flex flex-col items-center gap-5 sm:flex-row">
        <div className="relative h-28 w-32 shrink-0 overflow-hidden sm:h-32 sm:w-36">
          <Image
            ...
            unoptimized
            sizes="144px"
            alt={t("CodeQuest guide welcoming you back")}
        ...
        <div className="min-w-0 text-center sm:text-left">
          <p className="font-pixel text-xs uppercase tracking-[0.24em] text-[#899DFF]">
            {t("Player session restored")}
          </p>

          <h1 className="mt-2 break-words font-pixel text-3xl leading-tight text-white sm:text-4xl lg:text-5xl">
            {t("Welcome back,")}{" "}
